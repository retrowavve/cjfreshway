...
| v1.2 | 2026-08-21 | §2 프로모션 목록에 UPCOMING도 포함하도록 변경(진행중/진행예정 chip 필터 지원) |
...
**기본 흐름**
1. 진행 중/진행 예정 프로모션 목록을 조회한다(ONGOING·UPCOMING 상태만 노출, ENDED는 제외). 목록 화면에서 진행중/진행예정 chip으로 필터링할 수 있다.
