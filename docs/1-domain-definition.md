...
| 버전 | 날짜 | 변경내용 |
|------|------|----------|
| v1.0 | 2026-08-13 | 최초 작성: 핵심 엔티티(User, Promotion, Participation), 관계, 상태, 비즈니스 규칙 정의 |
| v1.1 | 2026-08-13 | 관리자(Admin) 액터·엔티티, 마이페이지, 반응형 UI 유스케이스 추가. MVP 포함/제외 범위 명시. 참여신청 상태전환(APPLIED/CANCELLED/REAPPLIED) 및 재추첨 불가 규칙 반영 |
| v1.2 | 2026-08-13 | ROULETTE 다회 참여 결과를 기록하지 못하던 구조적 공백 해소: ParticipationAttempt 엔티티 추가. 관리자 조기 종료 시 기존 참여 보존 예외케이스 추가 |
